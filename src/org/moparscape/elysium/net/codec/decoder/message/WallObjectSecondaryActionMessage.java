 ...
 * @author lothy
 */
public final class WallObjectSecondaryActionMessage extends AbstractMessage {

    private final int actionType;
    private final int actionX;
    private final int actionY;

    public WallObjectSecondaryActionMessage(int actionX, int actionY, int actionType) {
