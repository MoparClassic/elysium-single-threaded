...
//        tests.runPacketBuilderTests();
    ...
    public void populateBitpacker(org.moparscape.elysium.net.experimental.Bitpacker pb) {
        for (int i = 0; i < 10; i++) {
            pb.addBits(2047, 11);
            pb.addBits(8191, 13);
            pb.addBits(15, 4);
    ...
    public void populateBitpackerLarge(org.moparscape.elysium.net.experimental.Bitpacker pb) {
        for (int i = 0; i < 40; i++) {
            pb.addBits(2047, 11);
            pb.addBits(8191, 13);
            pb.addBits(15, 4);
    ...
    public void populatePacketBuilder(org.moparscape.elysium.net.experimental.PacketBuilder pb) {
        pb.writeByte(1);
        pb.writeShort(2);
        pb.writeInt(3);
        pb.writeLong(4);
    ...
    public void populatePacketBuilderLarge(org.moparscape.elysium.net.experimental.PacketBuilder pb) {
        for (int i = 0; i < 21; i++) {
            pb.writeLong(i + 1);
        }
        pb.finalisePacket();
    ...
    public void runBitpackerTests() {
        ...
        Bitpacker pb;
        org.moparscape.elysium.net.experimental.Bitpacker epb;
        ...
        epb = new org.moparscape.elysium.net.experimental.Bitpacker(buf, 99);
    ...
    public void runPacketBuilderTests() {
        ...
        ByteBuf buf = Unpooled.buffer(16384);
        org.moparscape.elysium.net.experimental.PacketBuilder epb =
                new org.moparscape.elysium.net.experimental.PacketBuilder(buf, 99);

        populatePacketBuilder(epb);
        print(buf);

        epb = new org.moparscape.elysium.net.experimental.PacketBuilder(buf, 99);
        populatePacketBuilder(epb);
        print(buf);
        ...
        epb = new org.moparscape.elysium.net.experimental.PacketBuilder(buf, 171);
        epb.finalisePacket();
        print(buf);
